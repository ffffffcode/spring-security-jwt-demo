package ex.aaronfae.graduation.configuration.security;
...
import ex.aaronfae.graduation.util.JwtTokenUtils;
...
public class JwtLoginFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * 如果使用此过滤器来触发登录认证流程，注意登录请求数据格式的问题 此过滤器的用户名密码默认从request.getParameter()获取，但是这种
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		HttpResult result = HttpResult.ok(token);
